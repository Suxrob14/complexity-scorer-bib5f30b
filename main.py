    """
    Complexity Scorer Bib5f30b
    ==========================
    Open-source NLP tool built to tag text data with state-of-the-art techniques.
    ...
    APP_NAME    = "Complexity Scorer Bib5f30b"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source NLP tool built to tag text data with state-of-the-art techniques.")
